...
public class HiScoreItems : HiScoreItemEnumeration
{
    ...
    public static HiScoreItems TombsOfAmascut =		new(79, "Tombs of Amascut", HiScoreTypeEnum.Boss);
    public static HiScoreItems TombsOfAmascutExpert = new(80, "Tombs of Amascut: Expert Mode", HiScoreTypeEnum.Boss);
    public static HiScoreItems TzKalZuk =			new(81, "TzKal-Zuk", HiScoreTypeEnum.Boss);
    public static HiScoreItems TzTokJad =			new(82, "TzTok-Jad", HiScoreTypeEnum.Boss);
    public static HiScoreItems Venenatis =			new(83, "Venenatis", HiScoreTypeEnum.Boss);
    public static HiScoreItems Vetion =				new(84, "Vet'ion", HiScoreTypeEnum.Boss);
    public static HiScoreItems Vorkath =			new(85, "Vorkath", HiScoreTypeEnum.Boss);
    public static HiScoreItems Wintertodt =			new(86, "Wintertodt", HiScoreTypeEnum.Boss);
    public static HiScoreItems Zalcano =			new(87, "Zalcano", HiScoreTypeEnum.Boss);
    public static HiScoreItems Zulrah =				new(88 ,"Zulrah", HiScoreTypeEnum.Boss);
}
